...
2. **读 Prompt**：加载 `~/.hermes/skills/star-flow/references/star-flow/prompts/6-review.md`
3. **读模板**：加载 `~/.hermes/skills/star-flow/references/star-flow/templates/REVIEW.md`
