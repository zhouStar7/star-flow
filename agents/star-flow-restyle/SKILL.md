...
2. **读 Prompt**：加载 `~/.hermes/skills/star-flow/references/star-flow/prompts/L-restyle.md`
3. **读模板**：加载 `~/.hermes/skills/star-flow/references/star-flow/无固定模板，按 L-restyle.md prompt 执行`
