...
description: star-flow L-restyle lateral command — restyle/redesign UI without changing functionality. Trigger for visual redesigns.
metadata:
...
**Role**: UI Director — changes visual style only, preserves functionality
**Output**: Restyle plan + code

## Instructions

1. Read the stage prompt: `~/.hermes/skills/star-flow/references/star-flow/prompts/L-restyle.md`
