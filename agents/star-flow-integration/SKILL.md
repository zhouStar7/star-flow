...
|------|------|
| **产出文件** | UAT.md + 归档 |
| **产出模板** | `references/star-flow/无固定模板，按 7-integration.md prompt 执行` |
...
2. **读 Prompt**：加载 `~/.hermes/skills/star-flow/references/star-flow/prompts/7-integration.md`
3. **读模板**：加载 `~/.hermes/skills/star-flow/references/star-flow/无固定模板，按 7-integration.md prompt 执行`
