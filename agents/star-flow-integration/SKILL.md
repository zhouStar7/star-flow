...
description: star-flow 7-integration stage — final UAT, smoke tests, archive. Trigger after review passes.
metadata:
...
**Output**: UAT.md + archive

## Instructions

1. Read the stage prompt: `~/.hermes/skills/star-flow/references/star-flow/prompts/7-integration.md`
