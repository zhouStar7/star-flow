...
2. **读 Prompt**：加载 `~/.hermes/skills/star-flow/references/star-flow/prompts/A-evolve.md`
3. **读模板**：加载 `~/.hermes/skills/star-flow/references/star-flow/无固定模板，按 A-evolve.md prompt 执行`
