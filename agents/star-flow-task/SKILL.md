---
name: star-flow-task
description: star-flow 3-task stage — break design into atomic tasks with dependencies. Trigger after design is confirmed.
metadata:
...
**Output**: .specs/<id>/TASK.md

## Instructions

1. Read the stage prompt: `~/.hermes/skills/star-flow/references/star-flow/prompts/3-task.md`
