...
| **产出模板** | `references/star-flow/templates/TASK.md` |
...
2. **读 Prompt**：加载 `~/.hermes/skills/star-flow/references/star-flow/prompts/3-task.md`
3. **读模板**：加载 `~/.hermes/skills/star-flow/references/star-flow/templates/TASK.md`
