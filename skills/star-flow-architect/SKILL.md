...
| **产出模板** | `references/templates/ARCHITECTURE.md` |
...
2. **读 Prompt**：加载 `../star-flow/references/prompts/A-architect.md`
3. **读模板**：加载 `../star-flow/references/templates/ARCHITECTURE.md`
